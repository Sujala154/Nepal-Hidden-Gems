...
import { FaList, FaPlus, FaComments, FaMountain, FaChartLine } from 'react-icons/fa';

const ContributorSidebar = ({ open, onClose }) => {
  const navItems = [
    ...
    <>
      ...
      >
        <div className="p-4 border-b border-slate-100 flex items-center gap-3">
          ...
          <h3 className="text-sm font-black">Contributor Dashboard</h3>
        </div>
