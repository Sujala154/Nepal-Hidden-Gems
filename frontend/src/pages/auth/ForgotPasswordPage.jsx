...
import { FaEnvelope, FaMountain } from "react-icons/fa";
          ...
          {sent ? (
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 text-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <p className="text-slate-500 text-sm leading-relaxed mb-6">
                We’ve sent a secure reset link to <br/><span className="font-bold text-slate-900">{email}</span>. Please click the link to reset your account access.
              </p>
              <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <h1 className="text-2xl font-black text-[#0b1f3a] mb-1.5 tracking-tight">Forgot password?</h1>
                <p className="text-slate-500 text-sm font-medium">Reset your credentials to secure your account.</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="e.g. sujalaadhikari918@gmail.com"
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-slate-900 placeholder:text-slate-300 transition-all text-sm font-medium"
                      required
                    />
                  </div>
                </div>
